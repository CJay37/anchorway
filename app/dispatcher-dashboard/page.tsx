...
const LOCATION_URL =
`https://xjqxtgejkrarlexamsy.supabase.co/functions/v1/get-driver-location?trip_reference=${TRACKING_REF}`;

const READINESS_URL =
`https://xjqxtgejkrarlexamsy.supabase.co/functions/v1/update-readiness-score?trip_reference=${TRACKING_REF}`;
